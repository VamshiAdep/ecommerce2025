const products = [
  ...
  },
  {
    ...
    description:
      '6.7-inch Super Retina XDR Display | A17 Pro chip | 48MP Main Camera | USB-C Port | Dynamic Island | iOS 17',
    brand: 'Apple',
  ...
  },
  {
    ...
    image: '/uploads/samsung-s24-ultra.jpg',
    description:
      '6.8-inch QHD+ AMOLED Display | Snapdragon 8 Gen 3 | 200MP Camera | S-Pen | 5000mAh Battery | Android 14',
    brand: 'Samsung',
    category: 'Mobile Phones',
    price: 149999,
    countInStock: 8,
  ...
  // Clothing
  {
    name: 'Men’s Cotton Casual Shirt - Blue Checked',
    image: '/uploads/blue-checked-shirt.jpg',
    description:
      '100% Cotton | Slim Fit | Casual Wear | Machine Washable | Available in Multiple Sizes',
    brand: 'Levis',
    category: 'Clothing',
    price: 1999,
    countInStock: 25,
  ...
  {
    name: 'Women’s Floral Summer Dress - Red',
    image: '/uploads/floral-summer-dress.jpg',
    description:
      'Lightweight Fabric | Sleeveless | Knee-Length | Elegant Design | Available in Multiple Sizes',
    brand: 'Zara',
    category: 'Clothing',
    price: 2999,
    countInStock: 15,
  ...
  // Home Electronics
  {
    name: 'LG 55-inch 4K UHD Smart OLED TV - AI ThinQ',
    image: '/uploads/lg-55-oled-tv.jpg',
    description:
      '55-inch 4K Ultra HD OLED | AI Processor | Dolby Atmos | Google Assistant & Alexa Built-in | Smart WebOS',
    brand: 'LG',
  ...
  {
    name: 'Dyson V12 Cordless Vacuum Cleaner - Absolute',
    image: '/uploads/dyson-v12.jpg',
    description:
      'Cord-Free Cleaning | Powerful Suction | HEPA Filtration | Lightweight & Ergonomic Design',
    brand: 'Dyson',
    category: 'Home Electronics',
    price: 59999,
    countInStock: 9,
